    ...
    <section className="py-20 bg-white">
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <AnimatedSection animation="fade-left">
            ...
            <div className="space-y-6 mb-8">
              {[
                {
                  delay: 0.1,
                  icon: <path d="M12 2L2 7l10 5 10-5-10-5z M2 17l10 5 10-5 M2 12l10 5 10-5" />,
                  title: 'Premium Materials',
                  desc: 'Only the finest fabrics from renowned mills worldwide',
                },
                {
                  delay: 0.2,
                  icon: (
                  ...
                  desc: 'Hand-tailored by master artisans with generations of expertise',
                },
                {
                  delay: 0.3,
                  icon: <path d="M20 6L9 17l-5-5" />,
                  title: 'Perfect Fit',
                  desc: 'Multiple fittings ensure every garment fits like a second skin',
                },
              ].map(({ delay, icon, title, desc }) => (
                <AnimatedSection key={title} animation="fade-left" delay={delay}>
          ...
          <AnimatedSection animation="fade-right" className="relative overflow-hidden rounded-lg">
