        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 pt-12 border-t border-gray-700">
            <div>
              ...
              <h3 className="font-semibold text-lg mb-2">Visit Our Atelier</h3>
              <p className="text-gray-400 text-sm">
                Experience our craftsmanship firsthand at our flagship location
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Speak with our style consultants for personalized assistance
              </p>
            </div>
            ...
            <div>
              ...
              <h3 className="font-semibold text-lg mb-2">Schedule Fitting</h3>
              <p className="text-gray-400 text-sm">
                Book an appointment for precise measurements and fittings
              </p>
            </div>
          </div>
        </div>
