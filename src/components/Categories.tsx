      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {categories.map((category, i) => (
            <AnimatedSection key={category.id} animation="fade-up" delay={i * 0.12}>
              <Link
                href={`/shop/category/${category.slug}`}
                className="group block rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
              >
