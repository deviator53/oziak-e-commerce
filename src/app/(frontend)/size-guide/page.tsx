                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Use a flexible measuring tape, not a rigid ruler. If you don&apos;t have
                        one, use string and measure against a ruler.
                      </p>
                    </div>
                  </div>
          ...
          <div className="bg-gray-50 p-8 rounded-lg">
            ...
            <div className="mt-8 p-4 bg-white rounded border-l-4 border-gray-900">
              <p className="text-gray-700">
                ...
                consultations and professional measurements. Contact us to schedule an appointment
                at our atelier.
              </p>
            </div>
          </div>
